  			...
  			try
			{
					...
					if(cn.equals("") || cadd.equals("") || cph.equals("") ||cem.equals("") || cpl.equals(""))// || mpl.equals("")|| madd.equals(""))
					{
						String msg = "Please fill all Necessory Data";
				      	JOptionPane.showMessageDialog(null,msg,"Agro Servises",
					...
					{ 	
				        ...
				        String qry="INSERT INTO company(comp_name,comp_addr,comp_phone,comp_email,comp_city,entry_Date)"+
				      	...
				      	Insert_Record.setString(1,cn);
				      	Insert_Record.setString(2,cadd);
				      	Insert_Record.setString(3,cph);
						Insert_Record.setString(4,cem);
				      	Insert_Record.setString(5,cpl);
