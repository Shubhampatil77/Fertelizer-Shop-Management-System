...
class dispcmp extends JFrame implements ActionListener
{
	...
	dispcmp()
	{
		super("Display Company Information");
		setLayout(null);
		l11=new JLabel("COMPANY DETAILS");
 ...
 class dispSearchCompany
{
	public static void main(String args[])
	{
		dispcmp sd=new dispcmp();
	}
}		
