...
class CustomerReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	CustomerReport()
	{
		...
		try
		{
			...
			String[] colHeads = {"Cust. Id.", "Customer Name", "Customer Addr","Profession", "Phone No", "Email"};
			...
			for (int i = 0; i < count; i++)
			{
				...
				results[i][4] = rs.getString(7);
				results[i][5] = rs.getString(5);
				rs.next();
			}
