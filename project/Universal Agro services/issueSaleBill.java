...
class issueSaleBill extends JFrame implements ActionListener
{
   ...
   issueSaleBill()
    {
	 ...
	 l5=new JLabel("* SALE BILL *");
	// l6=new JLabel("bill no");
	 l7=new JLabel("Customer no.");
	 l7.setToolTipText("Enter Customer name here");
	 l8=new JLabel("Customer name");
	 l8.setToolTipText("Enter Customer no here");
	...
	try
			{
				...
				conn = ConnectTODB.getConnection();
	  			...
	  			String qry = "SELECT sale_header.*,sale_header.sBill_no"+
					  " FROM sale_header WHERE (((sale_header.sBill_no)="+
					  "(SELECT Max(sale_header.sBill_no) AS Expr1 FROM sale_header;)));";
					  
				PreparedStatement Record = conn.prepareStatement(qry);
				ResultSet rs = Record.executeQuery(); // execute query
				rs.next();	int i = rs.getRow();
				
			txtbno.setText(""+ (rs.getInt("sbill_no") + 1));
	   ...
	   jt3.addKeyListener(new KeyAdapter() 
		{
			...
			try
			{
		        ...
		        qry = "SELECT customer.cust_Id,customer.cust_name FROM customer "+
 ...
 public void actionPerformed(ActionEvent e)
  {  
     if(e.getSource()==b1)
    	 {
	        ...
	        String cid = jt3.getText().trim(); //customer id
    	 ...
    	 try
			{
				if (conn!= null)
	            	conn.close(); 
				conn = ConnectTODB.getConnection();
					if(cid.equals("")|| qty.equals("") || prz.equals("") || paid.equals("") || bal.equals(""))
					{
			...
			try
			{
				...
				if (conn!= null)
					...
					{ 	
						// Query for Inserting record
			        String qry1="INSERT INTO sale_details(prod_name,qty,sale_id)"+
			        		   "VALUES(?,?,?)";			      
			        PreparedStatement Insert_Record=conn.prepareStatement(qry1);
			      	Insert_Record.setString(1,jtype1.getSelectedItem().toString());
			      	Insert_Record.setString(2,jt5.getText());
			      	Insert_Record.setString(3,bno+"");
					Insert_Record.execute(); // execute query
					 ...
					 try
					{
						...
						int updated_qty=ava_qty - Integer.parseInt(jt5.getText());
						
						if(updated_qty<0)
						{
							String msg1 = "Insufficient Stock For product :"+jtype1.getSelectedItem()+"..!!";
			      			JOptionPane.showMessageDialog((Component)null,msg1,"Agro Services",
			      			JOptionPane.INFORMATION_MESSAGE);	
						}
						else
				...
				if (conn!= null)
					...
					{ 	
						...
						String qry1="INSERT INTO sale_details(prod_name,qty,sale_id)"+
			        		   "VALUES(?,?,?)";			      
			        PreparedStatement Insert_Record=conn.prepareStatement(qry1);
			      	Insert_Record.setString(1,jtype2.getSelectedItem().toString());
			      	Insert_Record.setString(2,jt6.getText());
			      	Insert_Record.setString(3,bno+"");
					Insert_Record.execute(); // execute query
					 ...
					 try
					{
						...
						int ava_qty = rs.getInt("ava_qty");
						int updated_qty=ava_qty - Integer.parseInt(jt6.getText());
						if(updated_qty<0)
						{
							String msg1 = "Insufficient Stock For product :"+jtype2.getSelectedItem()+"..!!";
			      			JOptionPane.showMessageDialog((Component)null,msg1,"Agro Services",
			      			JOptionPane.INFORMATION_MESSAGE);	
						}
						else
	      	...
	      	try
			{
				...
				if (conn!= null)
					...
					{ 	
						// Query for Inserting record
							String qry1="INSERT INTO sale_details(prod_name,qty,sale_id)"+
			        		   "VALUES(?,?,?)";			      
			        PreparedStatement Insert_Record=conn.prepareStatement(qry1);
			      	Insert_Record.setString(1,jtype3.getSelectedItem().toString());
			      	Insert_Record.setString(2,jt7.getText());
			      	Insert_Record.setString(3,bno+"");
					Insert_Record.execute(); // execute query
					 ...
					 try
					{
						...
						int ava_qty = rs.getInt("ava_qty");
						int updated_qty=ava_qty - Integer.parseInt(jt7.getText());
						
						if(updated_qty<0)
						{
							String msg1 = "Insufficient Stock For product :"+jtype3.getSelectedItem()+"..!!";
			      			JOptionPane.showMessageDialog((Component)null,msg1,"Agro Services",
			      			JOptionPane.INFORMATION_MESSAGE);	
						}
						else
	      	...
	      	try
			{
				...
				if (conn!= null)
					...
					{ 	
						// Query for Inserting record
							String qry1="INSERT INTO sale_details(prod_name,qty,sale_id)"+
			        		   "VALUES(?,?,?)";			      
			        PreparedStatement Insert_Record=conn.prepareStatement(qry1);
			      	Insert_Record.setString(1,jtype4.getSelectedItem().toString());
			      	Insert_Record.setString(2,jt25.getText());
			      	Insert_Record.setString(3,bno+"");
					Insert_Record.execute(); // execute query
					 ...
					 try
					{
						...
						int ava_qty = rs.getInt("ava_qty");
						int updated_qty=ava_qty - Integer.parseInt(jt25.getText());
						
						if(updated_qty<0)
						{
							String msg1 = "Insufficient Stock For product :"+jtype4.getSelectedItem()+"..!!";
			      			JOptionPane.showMessageDialog((Component)null,msg1,"Agro Services",
			      			JOptionPane.INFORMATION_MESSAGE);	
						}
						else
	...
	String makeRecordPrint () 
	{
		...
		String data1 = "                  Sale Bill.         \n";
		String data10= "  Bill No        : " + bno.getText() + "\n";
		String data2 = "  Customer No.   : " + jt3.getText() + "\n";
		String data3 = "  Customer Name  : " + jt4.getText() + "\n";
		...
		data = data0 + sep0 + data1 + data10 + sep1 + data2 + data3 + sep2 + data4 + sep3 + data5 + data6 + data7 + data8 + data9 + sep4;
		return data;
