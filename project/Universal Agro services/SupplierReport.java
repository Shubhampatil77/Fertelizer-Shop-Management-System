...
class SupplierReport extends JFrame implements WindowListener, ActionListener
{
	int count = 0;
	...
	//	bprint.addActionListener(this);
		...
		try
		{
			...
			String[] colHeads = {"Supp.Id.", "Supplier Name", "Supplier Addr", "Supplier Company", "Phone No"};
